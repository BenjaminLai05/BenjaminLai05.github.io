 ...
 * and how their conditions may make them more susceptible to brain tumors.
 */
...
Currently, Mr. Smith is maintained on metformin 500mg twice daily, lisinopril 10mg daily, and aspirin 81mg daily. He is enrolled in a regular surveillance protocol with brain imaging performed every three months. His most recent scan was completed on November 15, 2024, with the next scheduled surveillance scan planned for February 15, 2025. Given the combination of genetic predisposition, environmental exposures, and age-related risk factors, his overall risk level for brain tumor development is classified as moderate to high.`,
  ...
  },
  {
    ...
    Gender: 'Female',
    Ethnicity: 'Caucasian',
    Narrative: `Sarah Johnson is a 34-year-old Caucasian female with a confirmed diagnosis of Neurofibromatosis Type 1 (NF1), which was established in childhood. This autosomal dominant genetic disorder results from mutations in the NF1 tumor suppressor gene, significantly increasing her lifetime risk of central nervous system tumors to approximately 15 to 20 percent. The patient exhibits characteristic features of NF1, including multiple café-au-lait spots and cutaneous neurofibromas.

Ms. Johnson has a significant history of a previous optic pathway glioma that was treated with chemotherapy between 2010 and 2012. This prior tumor development indicates an active tumor predisposition and demonstrates that her genetic condition has already manifested in CNS tumor formation. Patients with NF1 have a well-documented increased risk of developing pilocytic astrocytomas, gliomas, and meningiomas throughout their lifetime. The underlying genetic mutation affects tumor suppressor gene function, leading to dysregulated cell growth and proliferation.

She also has a well-controlled seizure disorder managed with levetiracetam, and she experiences learning disabilities that are secondary to her NF1 diagnosis. Her current medication regimen includes levetiracetam 1000mg twice daily, folic acid supplementation, and vitamin D3 2000 IU daily. Given her young age and the progressive nature of NF1-related tumors, she requires frequent and vigilant monitoring for new tumor development. Her most recent brain imaging was performed on December 1, 2024, with the next surveillance scan scheduled for January 15, 2025. Her risk level for brain tumor development is classified as high.`,
    MedicalHistory: [
...
Currently, Mr. Chen has no active malignancies and is not receiving any cancer-directed therapy. His medication regimen is limited to a daily multivitamin and calcium with vitamin D supplementation. However, given his genetic syndrome and previous cancer history, he requires aggressive surveillance with brain imaging performed every three to six months. His most recent scan was completed on November 20, 2024, with the next scheduled surveillance imaging planned for February 20, 2025. His risk level for brain tumor development is classified as very high, necessitating lifelong vigilant monitoring.`,
  ...
  },
  {
    ...
    Gender: 'Female',
    Ethnicity: 'Hispanic',
    Narrative: `Emily Rodriguez is a 45-year-old Hispanic female with a significant history of childhood acute lymphoblastic leukemia (ALL) that was successfully treated in 1995. As part of her treatment protocol, she received cranial radiation therapy with a total dose of 24 Gy to the cranium. This therapeutic radiation exposure significantly increases her risk of developing secondary brain tumors, with studies demonstrating a 10 to 20-fold increased risk compared to the general population.

The radiation-induced DNA damage from her childhood treatment can lead to the development of meningiomas, gliomas, and other central nervous system tumors, with a typical latency period of 10 to 30 years post-radiation. At age 45, Ms. Rodriguez is currently within the peak risk period for radiation-induced tumor development. Higher radiation doses, particularly those exceeding 20 Gy such as she received, have been shown to correlate with increased tumor risk. She has developed hypothyroidism secondary to her radiation exposure, which is managed with levothyroxine 75mcg daily, and she experiences mild cognitive deficits that are also attributed to her prior radiation treatment.

Ms. Rodriguez has had no recurrence of her leukemia and remains in complete remission. Her current medication regimen includes levothyroxine 75mcg daily, sertraline 50mg daily for depression, and a daily multivitamin. She is maintained on a regular surveillance protocol with brain imaging performed every three months. Her most recent scan was completed on October 10, 2024, with the next scheduled surveillance imaging planned for January 10, 2025. Given her radiation history and current age, her risk level for brain tumor development is classified as high.`,
    MedicalHistory: [
      'History of childhood leukemia (ALL, treated with cranial radiation therapy 1995)',
...
Mr. Kim has a significant smoking history with 40 pack-years of tobacco use, though he successfully quit in 2020. He also has a diagnosis of chronic obstructive pulmonary disease (COPD), which is managed with an albuterol inhaler as needed. His age of 71, combined with his extensive smoking history, increases his risk for both primary and secondary brain tumors. Additionally, the immunosuppressive effects of his active cancer and ongoing treatment may create an environment that allows for tumor growth and progression.

Currently, Mr. Kim is receiving targeted therapy with osimertinib 80mg daily for his lung adenocarcinoma. He is also maintained on prednisone 10mg daily, which is being tapered, and dexamethasone 4mg daily to manage brain edema associated with his metastases. Given the active nature of his disease, he requires very frequent surveillance with brain imaging performed monthly. His most recent scan was completed on December 5, 2024, with the next scheduled imaging planned for January 5, 2025. It is important to note that his previous radiation treatment for metastases can potentially cause secondary radiation-induced tumors in the future. His risk level for brain tumor development is classified as very high due to active disease.`,
    MedicalHistory: [
    ...
    CurrentMedications: [
      ...
      'Dexamethasone 4mg daily (for brain edema)'
    ],
...
Her current medication regimen includes ocrelizumab 600mg IV every six months, levothyroxine 50mcg daily, vitamin D3 5000 IU daily, and baclofen 10mg three times daily for spasticity management. It is worth noting that women between the ages of 30 and 50 represent a common demographic for both multiple sclerosis and certain types of brain tumors, which further supports the importance of surveillance. Her most recent brain imaging was performed on November 28, 2024, with the next scheduled scan planned for May 28, 2025. Her risk level for brain tumor development is classified as low to moderate.`,
  ...
  },
  {
    ...
    Gender: 'Male',
    Ethnicity: 'Caucasian',
    Narrative: `James Wilson is a 55-year-old Caucasian male with Von Hippel-Lindau (VHL) syndrome, a rare autosomal dominant genetic disorder confirmed through genetic testing that demonstrates a mutation in the VHL tumor suppressor gene. This condition carries a 60 to 80 percent lifetime risk of developing central nervous system hemangioblastomas, which are highly vascular tumors that can occur in the cerebellum, spinal cord, and brainstem.

Mr. Wilson has a significant history of multiple hemangioblastomas involving both the cerebellum and spinal cord. He underwent surgical resection of a cerebellar hemangioblastoma in 2020. His disease also demonstrates the characteristic multi-organ involvement typical of VHL syndrome, including renal cell carcinoma that was treated in 2019, and bilateral retinal hemangioblastomas that were successfully treated with laser therapy. This pattern of involvement across the central nervous system, kidneys, and eyes is pathognomonic for VHL syndrome and reflects the systemic nature of the genetic mutation.

The VHL gene mutation affects tumor suppressor function, leading to the development of these vascular tumors throughout the patient's lifetime. Currently, Mr. Wilson is not receiving active cancer treatment, but he is maintained on losartan for blood pressure management and follows a regular surveillance protocol. Given his previous tumor history and the active disease predisposition inherent to VHL syndrome, he requires lifelong surveillance for new hemangioblastoma development. His most recent brain imaging was performed on December 3, 2024, with the next scheduled surveillance scan planned for March 3, 2025. His risk level for brain tumor development is classified as high.`,
    MedicalHistory: [
      'Von Hippel-Lindau (VHL) syndrome - confirmed genetic mutation',
      'Multiple hemangioblastomas (cerebellum, spinal cord)',
      'Previous surgical resection of cerebellar hemangioblastoma (2020)',
      'Renal cell carcinoma (treated 2019)',
      'Retinal hemangioblastomas (bilateral, treated with laser)'
    ],
    CurrentMedications: [
      'No active cancer treatment',
...
The mTOR inhibitor everolimus, which she takes at a dose of 5mg daily, helps control SEGA growth but requires ongoing surveillance to monitor for any changes in tumor size or the development of new lesions. Additionally, she has multiple renal angiomyolipomas that are currently stable. Her current medication regimen also includes blood pressure medication and she follows a regular monitoring protocol. Given the genetic nature of TSC, she faces a lifelong risk of new tumor development. Her most recent brain imaging was performed on November 22, 2024, with the next scheduled surveillance scan planned for February 22, 2025. Her risk level for brain tumor development is classified as high.`,
    MedicalHistory: [
